106,5,62,0,0,106,108,5,62,0,0,107,109,5,62,0,0,108,107,1,0,0,0,108,109,1,
0,0,0,109,21,1,0,0,0,110,111,5,40,0,0,111,112,5,62,0,0,112,113,5,62,0,0,
113,23,1,0,0,0,114,115,5,41,0,0,115,116,3,36,18,0,116,25,1,0,0,0,117,118,
5,42,0,0,118,119,3,32,16,0,119,120,5,43,0,0,120,121,3,2,1,0,121,27,1,0,0,
0,122,123,5,44,0,0,123,124,3,38,19,0,124,29,1,0,0,0,125,126,7,4,0,0,126,
31,1,0,0,0,127,128,3,38,19,0,128,129,3,34,17,0,129,130,3,38,19,0,130,33,
1,0,0,0,131,132,7,5,0,0,132,35,1,0,0,0,133,134,7,6,0,0,134,37,1,0,0,0,135,
136,6,19,-1,0,136,137,5,58,0,0,137,138,3,38,19,0,138,139,5,59,0,0,139,143,
1,0,0,0,140,143,5,63,0,0,141,143,5,62,0,0,142,135,1,0,0,0,142,140,1,0,0,
0,142,141,1,0,0,0,143,155,1,0,0,0,144,145,10,6,0,0,145,146,5,7,0,0,146,154,
3,38,19,6,147,148,10,5,0,0,148,149,7,7,0,0,149,154,3,38,19,6,150,151,10,
4,0,0,151,152,7,8,0,0,152,154,3,38,19,5,153,144,1,0,0,0,153,147,1,0,0,0,
153,150,1,0,0,0,154,157,1,0,0,0,155,153,1,0,0,0,155,156,1,0,0,0,156,39,1,
0,0,0,157,155,1,0,0,0,10,42,46,65,89,95,101,108,142,153,155];
...
export default class ConsolaParser extends antlr4.Parser {
    ...
    static literalNames = [ null, "'set'", "'get'", "'add'", "'sub'", "'div'", 
                            "'mod'", "'pow'", "'inc'", "'dec'", "'len'", 
                            "'toupper'", "'tolower'", "'echo'", "'print'", 
                            "'alert'", "'mkdir'", "'ls'", "'cd'", "'open'", 
                            "'run'", "'save'", "'load'", "'vars'", "'del'", 
                            "'clear'", "'pause'", "'status'", "'time'", 
                            "'date'", "'version'", "'credits'", "'history'", 
                            "'uuid'", "'slug'", "'note'", "'notes'", "'encode'", 
                            "'decode'", "'template'", "'scaffold'", "'serve'", 
                            "'if'", "'then'", "'eval'", "'exit'", "'-v'", 
                            "'+'", "'-'", "'*'", "'/'", "'%'", "'<'", "'>'", 
                            "'<='", "'>='", "'=='", "'!='", "'('", "')'", 
                            "'='" ];
    static symbolicNames = [ null, "SET", "GET", "ADD", "SUB", "DIV", "MOD", 
                             "POW", "INC", "DEC", "LEN", "TOUPPER", "TOLOWER", 
                             "ECHO", "PRINT", "ALERT", "MKDIR", "LS", "CD", 
                             "OPEN", "RUN", "SAVE", "LOAD", "VARS", "DEL", 
                             "CLEAR", "PAUSE", "STATUS", "TIME", "DATE", 
                             "VERSION", "CREDITS", "HISTORY", "UUID", "SLUG", 
                             "NOTE", "NOTES", "ENCODE", "DECODE", "TEMPLATE", 
                             "SCAFFOLD", "SERVE", "IF", "THEN", "EVAL", 
                             "EXIT", "V_FLAG", "PLUS", "MINUS", "MUL", "DIV_SYM", 
                             "MOD_SYM", "LT", "GT", "LE", "GE", "EQEQ", 
                             "NEQ", "LPAREN", "RPAREN", "EQ", "STRING", 
                             "IDENT", "INT", "WS", "NEWLINE", "COMMENT" ];
	...
	program() {
	    ...
	    try {
	        ...
	        while((((_la) & ~0x1f) === 0 && ((1 << _la) & 4294967294) !== 0) || ((((_la - 32)) & ~0x1f) === 0 && ((1 << (_la - 32)) & 161791) !== 0)) {
	            this.state = 40;
	            this.statement();
	            this.state = 42;
	            this._errHandler.sync(this);
	...
	mathStmt() {
	    ...
	    try {
	        ...
	        this.state = 75;
	        _la = this._input.LA(1);
	        if(!((((_la) & ~0x1f) === 0 && ((1 << _la) & 248) !== 0) || _la===49)) {
...
ConsolaParser.INC = 8;
ConsolaParser.DEC = 9;
ConsolaParser.LEN = 10;
ConsolaParser.TOUPPER = 11;
ConsolaParser.TOLOWER = 12;
ConsolaParser.ECHO = 13;
ConsolaParser.PRINT = 14;
ConsolaParser.ALERT = 15;
ConsolaParser.MKDIR = 16;
ConsolaParser.LS = 17;
ConsolaParser.CD = 18;
ConsolaParser.OPEN = 19;
ConsolaParser.RUN = 20;
ConsolaParser.SAVE = 21;
ConsolaParser.LOAD = 22;
ConsolaParser.VARS = 23;
ConsolaParser.DEL = 24;
ConsolaParser.CLEAR = 25;
ConsolaParser.PAUSE = 26;
ConsolaParser.STATUS = 27;
ConsolaParser.TIME = 28;
ConsolaParser.DATE = 29;
ConsolaParser.VERSION = 30;
ConsolaParser.CREDITS = 31;
ConsolaParser.HISTORY = 32;
ConsolaParser.UUID = 33;
ConsolaParser.SLUG = 34;
ConsolaParser.NOTE = 35;
ConsolaParser.NOTES = 36;
ConsolaParser.ENCODE = 37;
ConsolaParser.DECODE = 38;
ConsolaParser.TEMPLATE = 39;
ConsolaParser.SCAFFOLD = 40;
ConsolaParser.SERVE = 41;
ConsolaParser.IF = 42;
ConsolaParser.THEN = 43;
ConsolaParser.EVAL = 44;
ConsolaParser.EXIT = 45;
ConsolaParser.V_FLAG = 46;
ConsolaParser.PLUS = 47;
ConsolaParser.MINUS = 48;
ConsolaParser.MUL = 49;
ConsolaParser.DIV_SYM = 50;
ConsolaParser.MOD_SYM = 51;
ConsolaParser.LT = 52;
ConsolaParser.GT = 53;
ConsolaParser.LE = 54;
ConsolaParser.GE = 55;
ConsolaParser.EQEQ = 56;
ConsolaParser.NEQ = 57;
ConsolaParser.LPAREN = 58;
ConsolaParser.RPAREN = 59;
ConsolaParser.EQ = 60;
ConsolaParser.STRING = 61;
ConsolaParser.IDENT = 62;
ConsolaParser.INT = 63;
ConsolaParser.WS = 64;
ConsolaParser.NEWLINE = 65;
ConsolaParser.COMMENT = 66;
